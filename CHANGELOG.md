## [3.1.0](https://github.com/banter240/tado_hijack/compare/v3.0.0...v3.1.0) (2026-01-30)
...
Dependencies:
- tadoasync==0.2.2 (forked version with custom patches)
- Home Assistant 2024.11.0+ (minimum required version)
- Python 3.12+ recommended

Infrastructure:
- CHANGELOG.md with comprehensive release notes
- Translations: English (en.json), German (de.json)
- GitHub Actions: PR tests, branch checks
- HACS compliance validated
- Manifest version bump to match release

Code Quality:
- Type hints throughout codebase (mypy compliant)
- Ruff linting with strict rules
- Pre-commit hooks enforce code style
- Sensitive data redaction in logs
- Unit test foundation (expandable)
